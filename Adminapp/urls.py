...
urlpatterns = [
    ...
    path('Bookings_details/',views.Bookings_details,name='Bookings_details'),
    ...
    path('delete_booking/<int:book_id>/',views.delete_booking,name='delete_booking'),
    path('view_review/',views.view_review,name='view_review'),
    path('delete_review/<int:re_id>/',views.delete_review,name='delete_review'),
